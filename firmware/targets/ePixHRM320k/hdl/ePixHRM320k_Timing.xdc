...
create_generated_clock -name timingGtRxOut \
    [get_pins {U_App/U_TimingRx/GEN_GT.U_GTH/LOCREF_G.U_TimingGthCore/inst/gen_gtwizard_gthe4_top.TimingGth_fixedlat_gtwizard_gthe4_inst/gen_gtwizard_gthe4.gen_channel_container[0].gen_enabled_channel.gthe4_channel_wrapper_inst/channel_inst/gthe4_channel_gen.gen_gthe4_channel_inst[0].GTHE4_CHANNEL_PRIM_INST/RXOUTCLK}]

create_generated_clock -name timingRefClkDiv2 \
    [get_pins {U_App/U_TimingRx/U_gtRefClk/ODIV2}]
...
create_generated_clock -name timingEmuRxClk -source \
    [get_pins -hier -filter {name =~ U_App/U_TimingRx/U_rxUsrClk/I1}] \
    -divide_by 1 -add -master_clock timingRefClkDiv2 \
    [get_pins -hier -filter {name =~ U_App/U_TimingRx/U_rxUsrClk/O}]

set_clock_groups -physically_exclusive \
    -group timingRxRecClk \
    -group timingEmuRxClk
...
set_clock_groups -asynchronous \
    -group [get_clocks -of_objects [get_pins U_App/U_TimingRx/U_gtRefClk/ODIV2]] \
    -group [get_clocks timingRxRecClk]
