...
set_property -dict {PACKAGE_PIN AH8 IOSTANDARD LVCMOS18} [get_ports {slowAdcDout[0]}]
set_property -dict {PACKAGE_PIN AD9 IOSTANDARD LVCMOS18} [get_ports {slowAdcDrdyL[0]}]
set_property -dict {PACKAGE_PIN AD8 IOSTANDARD LVCMOS18} [get_ports {slowAdcRefClk[0]}]
set_property -dict {PACKAGE_PIN AD10 IOSTANDARD LVCMOS18} [get_ports {slowAdcSyncL[0]}]
set_property -dict {PACKAGE_PIN AE10 IOSTANDARD LVCMOS18} [get_ports {slowAdcSclk[0]}]
set_property -dict {PACKAGE_PIN AE8 IOSTANDARD LVCMOS18} [get_ports {slowAdcDin[0]}]
set_property -dict {PACKAGE_PIN AF8 IOSTANDARD LVCMOS18} [get_ports {slowAdcCsL[0]}]
...
set_property -dict {PACKAGE_PIN AM32} [get_ports {asicDataP[3][22]}]
