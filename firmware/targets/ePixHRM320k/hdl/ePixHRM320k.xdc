...
set_property -dict {PACKAGE_PIN AL34} [get_ports {asicDataP[3][23]}]
set_property -dict {PACKAGE_PIN AM34} [get_ports {asicDataM[3][23]}]
set_property -dict {PACKAGE_PIN AK32} [get_ports {asicDataP[3][22]}]
set_property -dict {PACKAGE_PIN AN32} [get_ports {asicDataM[3][22]}]
set_property -dict {PACKAGE_PIN AN34} [get_ports {asicDataP[3][21]}]
set_property -dict {PACKAGE_PIN AP34} [get_ports {asicDataM[3][21]}]
set_property -dict {PACKAGE_PIN AN31} [get_ports {asicDataP[3][20]}]
set_property -dict {PACKAGE_PIN AP31} [get_ports {asicDataM[3][20]}]
set_property -dict {PACKAGE_PIN AN33} [get_ports {asicDataP[3][19]}]
set_property -dict {PACKAGE_PIN AP33} [get_ports {asicDataM[3][19]}]
set_property -dict {PACKAGE_PIN AL32} [get_ports {asicDataP[3][18]}]
set_property -dict {PACKAGE_PIN AL33} [get_ports {asicDataM[3][18]}]
set_property -dict {PACKAGE_PIN AH34} [get_ports {asicDataP[3][17]}]
set_property -dict {PACKAGE_PIN AJ34} [get_ports {asicDataM[3][17]}]
set_property -dict {PACKAGE_PIN AH31} [get_ports {asicDataP[3][16]}]
set_property -dict {PACKAGE_PIN AH32} [get_ports {asicDataM[3][16]}]
set_property -dict {PACKAGE_PIN AH33} [get_ports {asicDataP[3][15]}]
set_property -dict {PACKAGE_PIN AJ33} [get_ports {asicDataM[3][15]}]
set_property -dict {PACKAGE_PIN AJ30} [get_ports {asicDataP[3][14]}]
set_property -dict {PACKAGE_PIN AJ31} [get_ports {asicDataM[3][14]}]
set_property -dict {PACKAGE_PIN AK31} [get_ports {asicDataP[3][13]}]
set_property -dict {PACKAGE_PIN AK32} [get_ports {asicDataM[3][13]}]
set_property -dict {PACKAGE_PIN AJ29} [get_ports {asicDataP[3][12]}]
set_property -dict {PACKAGE_PIN AK30} [get_ports {asicDataM[3][12]}]
set_property -dict {PACKAGE_PIN AL30} [get_ports {asicDataP[3][11]}]
set_property -dict {PACKAGE_PIN AM30} [get_ports {asicDataM[3][11]}]
set_property -dict {PACKAGE_PIN AL29} [get_ports {asicDataP[3][10]}]
set_property -dict {PACKAGE_PIN AM29} [get_ports {asicDataM[3][10]}]
set_property -dict {PACKAGE_PIN AN29} [get_ports {asicDataP[3][9]}]
set_property -dict {PACKAGE_PIN AP30} [get_ports {asicDataM[3][9]}]
set_property -dict {PACKAGE_PIN AN27} [get_ports {asicDataP[3][8]}]
set_property -dict {PACKAGE_PIN AN28} [get_ports {asicDataM[3][8]}]
set_property -dict {PACKAGE_PIN AP28} [get_ports {asicDataP[3][7]}]
set_property -dict {PACKAGE_PIN AP29} [get_ports {asicDataM[3][7]}]
set_property -dict {PACKAGE_PIN AN26} [get_ports {asicDataP[3][6]}]
set_property -dict {PACKAGE_PIN AP26} [get_ports {asicDataM[3][6]}]
set_property -dict {PACKAGE_PIN AJ28} [get_ports {asicDataP[3][5]}]
set_property -dict {PACKAGE_PIN AK28} [get_ports {asicDataM[3][5]}]
set_property -dict {PACKAGE_PIN AH27} [get_ports {asicDataP[3][4]}]
set_property -dict {PACKAGE_PIN AH28} [get_ports {asicDataM[3][4]}]
set_property -dict {PACKAGE_PIN AL27} [get_ports {asicDataP[3][3]}]
set_property -dict {PACKAGE_PIN AL28} [get_ports {asicDataM[3][3]}]
set_property -dict {PACKAGE_PIN AK26} [get_ports {asicDataP[3][2]}]
set_property -dict {PACKAGE_PIN AK27} [get_ports {asicDataM[3][2]}]
set_property -dict {PACKAGE_PIN AM26} [get_ports {asicDataP[3][1]}]
set_property -dict {PACKAGE_PIN AM27} [get_ports {asicDataM[3][1]}]
...
set_property -dict {PACKAGE_PIN Y23  IOSTANDARD LVCMOS18} [get_ports { obTransScl }]
set_property -dict {PACKAGE_PIN AA23 IOSTANDARD LVCMOS18} [get_ports { obTransSda }]
set_property -dict {PACKAGE_PIN AB21 IOSTANDARD LVCMOS18} [get_ports { obTransResetL }]
set_property -dict {PACKAGE_PIN AC21 IOSTANDARD LVCMOS18} [get_ports { obTransIntL }]

set_property -dict { PACKAGE_PIN AA20 IOSTANDARD LVCMOS18 } [get_ports { dcdcSync }]
set_property -dict { PACKAGE_PIN AB20 IOSTANDARD LVCMOS18 } [get_ports { pcbSync  }]
...
##	Bank 71
##########################
set_property -dict {PACKAGE_PIN H21} [get_ports {asicDataP[1][23]}]
set_property -dict {PACKAGE_PIN G21} [get_ports {asicDataM[1][23]}]
set_property -dict {PACKAGE_PIN G22} [get_ports {asicDataP[1][22]}]
set_property -dict {PACKAGE_PIN F22} [get_ports {asicDataM[1][22]}]
set_property -dict {PACKAGE_PIN G20} [get_ports {asicDataP[1][21]}]
set_property -dict {PACKAGE_PIN F20} [get_ports {asicDataM[1][21]}]
set_property -dict {PACKAGE_PIN F23} [get_ports {asicDataP[1][20]}]
set_property -dict {PACKAGE_PIN F24} [get_ports {asicDataM[1][20]}]
set_property -dict {PACKAGE_PIN E20} [get_ports {asicDataP[1][19]}]
set_property -dict {PACKAGE_PIN E21} [get_ports {asicDataM[1][19]}]
set_property -dict {PACKAGE_PIN G24} [get_ports {asicDataP[1][18]}]
set_property -dict {PACKAGE_PIN F25} [get_ports {asicDataM[1][18]}]
set_property -dict {PACKAGE_PIN D20} [get_ports {asicDataP[1][17]}]
set_property -dict {PACKAGE_PIN D21} [get_ports {asicDataM[1][17]}]
set_property -dict {PACKAGE_PIN B20} [get_ports {asicDataP[1][16]}]
set_property -dict {PACKAGE_PIN A20} [get_ports {asicDataM[1][16]}]
set_property -dict {PACKAGE_PIN C21} [get_ports {asicDataP[1][15]}]
set_property -dict {PACKAGE_PIN C22} [get_ports {asicDataM[1][15]}]
set_property -dict {PACKAGE_PIN B21} [get_ports {asicDataP[1][14]}]
set_property -dict {PACKAGE_PIN B22} [get_ports {asicDataM[1][14]}]
set_property -dict {PACKAGE_PIN E22} [get_ports {asicDataP[1][13]}]
set_property -dict {PACKAGE_PIN E23} [get_ports {asicDataM[1][13]}]
set_property -dict {PACKAGE_PIN D23} [get_ports {asicDataP[1][12]}]
set_property -dict {PACKAGE_PIN C23} [get_ports {asicDataM[1][12]}]
set_property -dict {PACKAGE_PIN D24} [get_ports {asicDataP[1][11]}]
set_property -dict {PACKAGE_PIN C24} [get_ports {asicDataM[1][11]}]
set_property -dict {PACKAGE_PIN E25} [get_ports {asicDataP[1][10]}]
set_property -dict {PACKAGE_PIN D25} [get_ports {asicDataM[1][10]}]
set_property -dict {PACKAGE_PIN B24} [get_ports {asicDataP[1][9]}]
set_property -dict {PACKAGE_PIN A24} [get_ports {asicDataM[1][9]}]
set_property -dict {PACKAGE_PIN C26} [get_ports {asicDataP[1][8]}]
set_property -dict {PACKAGE_PIN B26} [get_ports {asicDataM[1][8]}]
set_property -dict {PACKAGE_PIN B25} [get_ports {asicDataP[1][7]}]
set_property -dict {PACKAGE_PIN A25} [get_ports {asicDataM[1][7]}]
set_property -dict {PACKAGE_PIN E26} [get_ports {asicDataP[1][6]}]
set_property -dict {PACKAGE_PIN D26} [get_ports {asicDataM[1][6]}]
set_property -dict {PACKAGE_PIN A27} [get_ports {asicDataP[1][5]}]
set_property -dict {PACKAGE_PIN A28} [get_ports {asicDataM[1][5]}]
set_property -dict {PACKAGE_PIN D28} [get_ports {asicDataP[1][4]}]
set_property -dict {PACKAGE_PIN C28} [get_ports {asicDataM[1][4]}]
set_property -dict {PACKAGE_PIN B29} [get_ports {asicDataP[1][3]}]
set_property -dict {PACKAGE_PIN A29} [get_ports {asicDataM[1][3]}]
set_property -dict {PACKAGE_PIN E28} [get_ports {asicDataP[1][2]}]
set_property -dict {PACKAGE_PIN D29} [get_ports {asicDataM[1][2]}]
set_property -dict {PACKAGE_PIN C27} [get_ports {asicDataP[1][1]}]
set_property -dict {PACKAGE_PIN B27} [get_ports {asicDataM[1][1]}]
...
##	Bank 66
##########################
set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutP[1][4]}]
set_property -dict {PACKAGE_PIN H13 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutM[1][4]}]
set_property -dict {PACKAGE_PIN L12 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutP[1][3]}]
set_property -dict {PACKAGE_PIN K12 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutM[1][3]}]
set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutP[1][2]}]
set_property -dict {PACKAGE_PIN K13 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutM[1][2]}]
set_property -dict {PACKAGE_PIN K11 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutP[1][1]}]
set_property -dict {PACKAGE_PIN J11 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutM[1][1]}]
...
set_property -dict {PACKAGE_PIN J9 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutP[0][7]}]
set_property -dict {PACKAGE_PIN H9 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutM[0][7]}]
set_property -dict {PACKAGE_PIN L8 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutP[0][6]}]
set_property -dict {PACKAGE_PIN K8 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutM[0][6]}]
set_property -dict {PACKAGE_PIN E10 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutP[0][5]}]
set_property -dict {PACKAGE_PIN D10 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutM[0][5]}]
set_property -dict {PACKAGE_PIN D9 IOSTANDARD LVCMOS18v} [get_ports {adcMonDoutP[0][4]}]
set_property -dict {PACKAGE_PIN C9 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutM[0][4]}]
set_property -dict {PACKAGE_PIN B10 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutP[0][3]}]
set_property -dict {PACKAGE_PIN A10 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutM[0][3]}]
set_property -dict {PACKAGE_PIN D8 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutP[0][2]}]
set_property -dict {PACKAGE_PIN C8 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutM[0][2]}]
set_property -dict {PACKAGE_PIN B9 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutP[0][1]}]
set_property -dict {PACKAGE_PIN A9 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutM[0][1]}]
set_property -dict {PACKAGE_PIN F8 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutP[0][0]}]
set_property -dict {PACKAGE_PIN E8 IOSTANDARD LVCMOS18} [get_ports {adcMonDoutM[0][0]}]
...
set_property PACKAGE_PIN V6  [get_ports {gtPllClkP[1]}]
set_property PACKAGE_PIN V5  [get_ports {gtPllClkM[1]}]
